...
public class ToolsConfig {
    ...
    public ToolCallbackProvider toolCallbackProvider() {
        ...
        // 获取所有可能包含工具方法的Bean
        collectTools(Service.class, toolObjects);
        collectTools(Component.class, toolObjects);
    ...
    private <A extends Annotation> void collectTools(Class<A> annotationType, List<Object> toolObjects) {
